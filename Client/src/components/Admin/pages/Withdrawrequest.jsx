                            ...
                            <td>
                              <div>
                                <small>
                                  ...
                                  <strong>Account:</strong> {withdrawal.users?.account_number || 'N/A'}<br />
                                </small>
                              </div>
                            </td>
                            <td>
                            ...
                            <td>
                              <div className="d-flex gap-2">
                                <button
                                  ...
                                  onClick={() => updateWithdrawalStatus(withdrawal.id, 'processed')}
                                  disabled={withdrawal.status === 'processed' || withdrawal.status === 'rejected'}
                                >
